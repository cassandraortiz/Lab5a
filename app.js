...
// This problem was pre-done by Roger, and only making this comment to A-C-P the branch.
testSum(4, 7);
...
// var productA = multiply(4, 7)[0];
// var answerProduct = multiply(productA, 5)[0];
// console.log(multiply(number1, sum2)[0]);

// Write your code here
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var sumA = sum(a, b)[0];
    var answerSum = sum(sumA, c)[0];
...
function multiplyArray(multArr) { //eslint-disable-line
    var arrProductA = multiply(multArr[0], multArr[1])[0];
    var answerArrProduct = multiply(arrProductA, multArr[2])[0];

    var testArrayString2 = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + answerArrProduct + '.'
    // console.log(answerArraySum);
    return [answerArrProduct,testArrayString2];
}
